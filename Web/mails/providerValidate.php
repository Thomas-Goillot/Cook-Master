															...
															<td class="pad" style="padding-bottom:10px;padding-left:40px;padding-right:40px;padding-top:10px;">
																<div style="font-family: Arial, sans-serif">
																	<div class="" style="font-size: 12px; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; color: #555555; line-height: 1.2;">
																		<p style="margin: 0; font-size: 16px; text-align: center;"><span style="font-size:30px;color:#2b303a;"><strong>Validation de votre cours</strong></span></p>
																	</div>
																</div>
															</td>
														</tr>
																...
																<div style="font-family: sans-serif">
																	<div class="" style="font-size: 12px; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; color: #555555; line-height: 1.5;">
																		<p style="margin: 0; font-size: 14px; text-align: center;"><span style="color:#808389;font-size:15px;">
																				...
																				<p> Nous avons de bonnes nouvelles pour vous !</p>
																				<p> Un de nos préstataires vient de valider votre demande de cours.</p>
																				<p> Vous pouvez dès à présent vous connecter à votre espace personnel pour voir les détails de votre cours.</p>
