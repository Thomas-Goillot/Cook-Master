...
class Events extends Controller
{
    ...
    {   
        ...
        if (isset($_POST['EventName']) && isset($_POST['EventDescription']) && isset($_POST['EventEntryPrice']) || isset($_POST['EventDate']) || isset($_POST['EventTemplateId'])) {
            ...
            if (empty($EventName) || empty($EventDescription) || empty($EventEntryPrice) || empty($EventDate) || empty($EventTemplateId)) {
            ...
            $res = $this->_model->addEvent($EventName, $EventDescription, $EventEntryPrice, $userId, $EventDate['start'], $EventDate['end']);
    ...
    public function editEvent(): void
    {
        ...
        if (isset($_POST['EventName']) && isset($_POST['EventDescription']) && isset($_POST['EventEntryPrice']) || isset($_POST['EventDate']) || isset($_POST['EventId'])) {
            $EventName = htmlspecialchars($_POST['EventName']);
            $EventDescription = htmlspecialchars($_POST['EventDescription']);
            $EventEntryPrice = htmlspecialchars($_POST['EventEntryPrice']);
            $EventDate = htmlspecialchars($_POST['EventDate']);
            ...
            if (empty($EventName) || empty($EventDescription) || empty($EventEntryPrice) || empty($EventDate) || empty($EventId)) {
                $this->setError("Echéc de l\'ajout", "Veuillez remplir tous les champs", ERROR_ALERT);
                $this->redirect($defaultFallBack);
                exit();
            }
            ...
            $res = $this->_model->updateEvent($EventId , $EventName, $EventDescription, $EventEntryPrice, $userId, $EventDate['start'], $EventDate['end']);
