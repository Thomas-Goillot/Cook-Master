...
<head>
    ...
    <title>Facture des évènements à venir</title>
</head>
<body style="font-family: Arial, sans-serif; background-color: white;">
    ...
    <h1 class="centre1" style="display: flex; justify-content: center; margin-bottom: 4rem; color: black;">Facture des évènements passés</h1>
