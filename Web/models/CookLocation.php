...
class cookLocation extends Model
{
     ...
     * @return void
     */
    public function reservationCookLocation( int $id_users, int $id_location, string $start_rental, string $date_reservation, string $end_rental): void
    {
        $query = "INSERT INTO rent_location (id_users,id_location,start_rental,date_reservation,end_rental) VALUES (:id_users, :id_location,:start_rental,:date_reservation,:end_rental)";
