...
<?php
    foreach ($subscriptionAllInfo as $subscription) {
        if($subscription['is_active'] == 1 || $numberOfSubscriptionAllInfo == 1) {
        echo "
        <div class=\"col-md-4\">
            <div class=\"card card-pricing\">
                <div class=\"card-body text-center\">
                    ...
                    echo "<li>
                        <i class=\"text-success fas fa-check\" id=\"subscriptionRewards_pricing\"></i> " . ucfirst(strtolower($subscriptionAllInfo[0]['access_to_lessons'])) . " leçon 
                        </li>";
