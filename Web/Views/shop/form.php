<div class="form-group">
    ...
    <div class="form-group d-flex flex-column align-items-center">
        <div id="rent">
            <label class="space">Stock disponible</label>
            <input type="number" data-toggle="touchspin" data-step="1" data-decimals="0" name="disponibilityStock" data-bts-postfix=" " min="0" required="" class="form-control" value="<?= isset($product['stock']) ? $product['stock'] : "" ?>">
        </div id="rent">
    </div>
