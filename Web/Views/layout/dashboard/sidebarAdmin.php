...
<li>
    ...
    <ul class="sub-menu" aria-expanded="false">
        <li><a href="<?= $path_prefix ?>workshop/index"><i class="bx bx-list-ul"></i>Liste des ateliers</a></li>
        <li><a href="<?= $path_prefix ?>workshop/createWorkshop"><i class="bx bx-bookmark-plus"></i>Créer un atelier</a></li>
    </ul>
</li>
