            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h1 class="modal-title fs-5" id="exampleModalToggleLabel">Inscription</h1>
                                <button class="btn-account" data-bs-target="#exampleModalToggle5" data-bs-toggle="modal">
                                    <a class="modal-title fs-5 connexion">Déjà un compte ? </a>
                                </button>
                            ...
                            <div class="modal-body">
                                ...
                                <label>Prénom :</label>
                                <input type="text" class="form-control" placeholder="Votre prénom" name="surname" required>
                                <label>Email :</label>
                                <input type="email" class="form-control" placeholder="Votre mail" name="email" required>
                                <label>Téléphone :</label>
                                <input type="number" class="form-control" placeholder="Votre numéro de téléphone" name="tel" required>

                            </div>
                            <div class="modal-footer">
                                <button class="btn btn-primary btn-account" data-bs-target="#exampleModalToggle2" data-bs-toggle="modal">
                                    <img src="<?= $path_prefix ?>assets/images/home/right.png" width="20px">
                                </button>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal fade" id="exampleModalToggle2" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2" tabindex="-1">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h1 class="modal-title fs-5" id="exampleModalToggleLabel2">Adresse :</h1>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <label>Rue :</label>
                                <input type="text" class="form-control" placeholder="Votre Rue" name="street" required>
                                <label>Numéro :</label>
                                <input type="number" class="form-control" placeholder="Votre Numéro d'habitation" name="number" required>
                                <label>Ville :</label>
                                <input type="text" class="form-control" placeholder="Votre Ville" name="town" required>
                                <label>Code postal :</label>
                                <input type="number" class="form-control" placeholder="Votre code postal" name="postal" required>
                            </div>
                            <div class="modal-footer">
                                <button class="btn btn-primary btn-account" data-bs-target="#exampleModalToggle" data-bs-toggle="modal">
                                    <img src="<?= $path_prefix ?>assets/images/home/left.png" width="20px">
                                </button>

                                <button class="btn btn-primary btn-account" data-bs-target="#exampleModalToggle3" data-bs-toggle="modal">
                                    <img src="<?= $path_prefix ?>assets/images/home/right.png" width="20px">
                                </button>
                            </div>
                        </div>
                ...
                <div class="modal fade" id="exampleModalToggle3" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2" tabindex="-1">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h1 class="modal-title fs-5" id="exampleModalToggleLabel2">Dernière étape !</h1>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                ...
                                <input type="password" class="form-control" placeholder="Confirmation" name="number" required>
                            </div>
                            <div class="modal-footer">
                                <button class="btn btn-primary btn-account" data-bs-target="#exampleModalToggle2" data-bs-toggle="modal">
                                    <img src="<?= $path_prefix ?>assets/images/home/left.png" width="20px">
                                ...
                                <button class="btn btn-primary btn-account" type="submit">
                                    Inscription
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer forgot">
                                <button class="btn-account forgot" data-bs-target="#exampleModalToggle6" data-bs-toggle="modal">
                                    Mot de passe oublié
                                </button>
                                <button class="btn btn-primary btn-account" type="submit">
                                    Connexion
                ...
                <div class="modal fade" id="exampleModalToggle6" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2" tabindex="-1">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h1 class="modal-title fs-5" id="exampleModalToggleLabel2">Mot de passe oublié</h1>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <label>Email :</label>
                ...
                <button class="btn btn-primary btn-account" data-bs-target="#exampleModalToggle" data-bs-toggle="modal">
                    <img src="<?= $path_prefix ?>assets/images/home/account.png" width="20px">
                </button>
            </div>
        </div>
    </nav>
