...
echo '  <div class="col-12 margin">
            <div class="position-relative">
                <img src="' . $path_prefix  . 'assets/images/events/' . $workshop['image'] . '" class="img-thumbnail">
...
<div class="row">
<div class="col-4">
<form action="' . $path_prefix . 'WorkshopPresentation/pay/' . $workshop['id_event'] . '" method="POST">
