...
<div class="row">
    <div class="col-xl-6">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title" data-translation-key="Utilisateurs"></h4>
                <p class="card-subtitle mb-4" data-translation-key="NombreNouveauxUtilisateurs"></p>
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title" data-translation-key="Abonnements"></h4>
                <p class="card-subtitle mb-4" data-translation-key="TypeAbonnementUtilisateur"></p>
...
<div class="row">
    <div class="col-xl-6">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title" data-translation-key="NombresRecettes"></h4>
                <p class="card-subtitle mb-4" data-translation-key="NombresRecettesType"></p>
